...
- **The work** — every feature, task, research question, and open item — is now **GitHub
  ...
  [`label:pkg:hermes`](https://github.com/codelisperer/ouranos/issues?q=is%3Aissue+is%3Aopen+label%3A%22pkg%3Ahermes%22).
...
- **The reasoning** — the design narrative, trade-offs, rejected alternatives, and open
  ...
  [`docs/wiki/Framework-Hermes.md`](../../docs/wiki/Framework-Hermes.md).
...
New work goes in an issue (`gh issue create --label ai-task,pkg:hermes …` for AI/system tasks —
