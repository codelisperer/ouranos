...
- **The work** — every feature, task, research question, and open item — is now **GitHub
  ...
  [`label:pkg:aion`](https://github.com/codelisperer/ouranos/issues?q=is%3Aissue+is%3Aopen+label%3A%22pkg%3Aaion%22).
...
New work goes in an issue (`gh issue create --label ai-task,pkg:aion …` for AI/system tasks —
