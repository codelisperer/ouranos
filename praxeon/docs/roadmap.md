...
- **The work** — every feature, task, research question, and open item — is now **GitHub
  ...
  [`label:pkg:praxeon`](https://github.com/codelisperer/ouranos/issues?q=is%3Aissue+is%3Aopen+label%3A%22pkg%3Apraxeon%22).
...
- **The reasoning** — the design narrative, trade-offs, rejected alternatives, and open
  ...
  [`docs/wiki/Framework-Praxeon.md`](../../docs/wiki/Framework-Praxeon.md).
...
New work goes in an issue (`gh issue create --label ai-task,pkg:praxeon …` for AI/system tasks —
