...
- **The work** — every feature, task, research question, and open item — is now **GitHub
  ...
  [`label:pkg:elenchon`](https://github.com/codelisperer/ouranos/issues?q=is%3Aissue+is%3Aopen+label%3A%22pkg%3Aelenchon%22).
...
New work goes in an issue (`gh issue create --label ai-task,pkg:elenchon …` for AI/system tasks —
